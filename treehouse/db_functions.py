...
def drop_tables():
    ...
    for table in bar(("COURSES", "ENROLMENTS", "SURVEYS", "METRICS", "USERS",
...
def initialiseDB():
    ...
    bar = progressbar.ProgressBar()
    for query in bar((courses, enrolments, surveys, metrics, users, questions,
                      survey_questions, surveys_completed, guest_approvals)):
        dbadd(query)
...
go = input("This will reset the database.\nAre you sure you want to continue? (y/n): ")
if go != 'y':
    sys.exit('Good choice')
# UNCOMMENT DEPENDING ON ACTION
...
time.sleep(1)
initialiseDB()
print("initialising courses ...")
time.sleep(1)
init_courses()
print("initialising users ...")
time.sleep(1)
init_users()
